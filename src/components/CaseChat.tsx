...
export default function CaseChat({ currentCase }: { currentCase?: CurrentCase }) {
  ...
  return (
    <>
      ...
      <button
        ...
        className="mt-6 inline-flex items-center gap-3 rounded-2xl border border-violet-400/50 bg-violet-600/70 px-10 py-5 text-[20px] font-semibold text-white backdrop-blur-sm transition-all hover:bg-violet-500/80 hover:scale-[1.02] active:scale-[0.98] shadow-[0_0_20px_rgba(124,58,237,0.4)]"
